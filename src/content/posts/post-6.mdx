...
Images that you want optimized by Astro should first move their images to any folder within the `src` directory.
I've set up an [import alias](/posts/post-4), see below:
